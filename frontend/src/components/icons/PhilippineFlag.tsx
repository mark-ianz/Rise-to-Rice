...
export default function PhilippineFlag({ className }: Props) {
  return (
    <svg
      viewBox="0 0 36 36"
      ...
      aria-hidden="true"
      role="img"
      className={cn("iconify iconify--twemoji", className)}
